...
$subject=mysqli_query($con,"select * from subject order by subject_id");
                    ...
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-danger">Show Report</h6>
                            ...
                            <!-- Card Body -->
                            <div class="card-body">
                                <form action="show_report2.php" method="post">
                                    <div class="form-row">
                                 ...
                                 echo ' <option value="">None</option>';
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                        <label for="inputPassword4">Select Subject</label>
                                            <select required name="subject" class="form-control" id="textboxid">
                                                <?php
                                 echo ' <option value="">None</option>';
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Select From Date</label>
                                            
                                            <input type="date" required name="form_date" class="form-control">
                                            
                                        
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Select To Date</label>
