...
if(isset($_GET['updateid']))
{
    ...
    $query="select * from users where user_id=$userupdateid";
    $row=mysqli_query($con,$query);
    $record=mysqli_fetch_array($row);
    // $userid=$record['user_id'];
    // $username=$record['username'];
    // $usertype=$record['user_type'];
    // $useremail=$record['email_id'];
        ...
        <div class="inner">
            <form method="post" action="">
                ...
                <div class="form-group">
                    <input type="text" name="username" value="<?php echo $record['username'] ?>" placeholder="username" class="form-control">
                ...
                <div class="form-wrapper">
                    <input type="password" name="password" value="<?php echo $record['password'] ?>"placeholder="Password" class="form-control">
...
if(isset($_GET['submit']))
{
    ...
    $query="update users set user_id=$userid,username=$username,user_type=$usertype,
    email=$useremail,password=$userpassword where user_id=";
